    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="医院名称" prop="yiyuanmingcheng">
          <el-select :disabled="ro.yiyuanmingcheng" v-model="ruleForm.yiyuanmingcheng" placeholder="请选择医院名称">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="医生姓名" prop="yishengxingming">
          <el-select :disabled="ro.yishengxingming" v-model="ruleForm.yishengxingming" placeholder="请选择医生姓名">
            <el-option
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/yishengxinxi/yishengxingming`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.paibanbiao = this.ruleForm.paibanbiao.replace(reg,'../../../ssm68n0w/upload');
	this.ruleForm.keshijieshao = this.ruleForm.keshijieshao.replace(reg,'../../../ssm68n0w/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
