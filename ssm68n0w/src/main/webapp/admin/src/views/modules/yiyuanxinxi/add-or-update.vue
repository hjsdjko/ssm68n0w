<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医院领导" prop="yiyuanlingdao">
          <el-input v-model="ruleForm.yiyuanlingdao" 
              placeholder="医院领导" clearable  :readonly="ro.yiyuanlingdao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医院领导" prop="yiyuanlingdao">
              <el-input v-model="ruleForm.yiyuanlingdao" 
                placeholder="医院领导" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
